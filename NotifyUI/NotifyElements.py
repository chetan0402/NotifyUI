...
class NotifyApplication:
    ...
    def send_notification(self):
        ...
        if not self.notification_sent:
            ...
            raise Exception("Create a new application instance to send another notification.")

class NotifyWindow(QMainWindow):
    style_sheet=""
    close_if_clicked=False
    ...
    def __init__(self) -> None:
        ...
        ava_space=QtGui.QGuiApplication.primaryScreen().availableGeometry().bottomRight()
        x=ava_space.x()-self.frameGeometry().width()-10
        y=ava_space.y()-self.frameGeometry().height()-10
        self.move(x,y)
        self.setBackgroundColor("#272727")
        self.appendStyle("border-radius","10px")
...
def __sendWinStyleNotify(app_name:str,title:str,msg:str) -> None:
    ...
    NotifyText(app.window,10,70,msg,font=QtGui.QFont("Segoe UI",10,QtGui.QFont.Weight.Normal),color="#a5a5a5")
